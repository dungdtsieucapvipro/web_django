...
def checkout(request):
    if request.user.is_authenticated:
        ...
        # Lấy thông tin người dùng đã đăng nhập và truyền vào context
        user_info = {
    ...
    categories = Category.objects.filter(is_sub=False)
    context = {'categories': categories, 'items': items, 'order': order, 'cartItems': cartItems, 'user_info': user_info}
